...
import myus.dto.EnrollmentRequest;
import myus.dto.EnrollmentResponse;
...
public interface EnrollmentService {
     ...
     * @throws myus.exception.ResourceNotFoundException if student or offering not found
     * @throws myus.exception.EnrollmentException       if duplicate or capacity exceeded
     */
     ...
     * @throws myus.exception.ResourceNotFoundException if registration not found
     * @throws myus.exception.EnrollmentException       if not owned by student or already dropped
     */
