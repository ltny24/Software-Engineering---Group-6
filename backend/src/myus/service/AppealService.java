...
public interface AppealService {
     ...
     */
    List<myus.dto.appeal.AppealSummaryResponse> getStudentAppeals(String username);

    /**
     * Retrieve detailed appeal info by tracking code or ID for student.
     */
    myus.dto.appeal.AppealDetailResponse getAppealDetailByCode(String trackingCode, String username);
