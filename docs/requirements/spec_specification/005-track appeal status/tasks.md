...
- [ ] T041-02 [US2] [FG2] Perform manual end-to-end acceptance testing: Login as student (`24127595`) -> Open Status Dashboard -> Filter by "Resolved" -> Click row -> Verify admin feedback notes and updated score render correctly in the slide-over drawer.
